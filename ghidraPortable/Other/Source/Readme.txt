...
user in an INI file next to ghidraPortable.exe called ghidraPortable.ini.
...
copy AppNamePortable.ini from this directory to ghidraPortable.ini next to
ghidraPortable.exe. The options in the INI file are as follows:
